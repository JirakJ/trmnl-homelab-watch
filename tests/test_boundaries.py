from trmnl_homelab_watch import collector
import unittest
from unittest.mock import patch
from trmnl_homelab_watch.common import ConfigurationError, NoRedirect, clock, packet, push, request
...
class BoundaryTests(unittest.TestCase):
    def test_demo_fits_and_cannot_be_published(self):
        ...
        with patch("trmnl_homelab_watch.common.request") as network:
